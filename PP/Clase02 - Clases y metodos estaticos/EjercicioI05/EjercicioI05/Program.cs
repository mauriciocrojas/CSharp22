...
//Crear una aplicación de consola que permita al usuario ingresar
//un número entero.

//Desarrollar un método estático que reciba un número y devuelva
//la tabla de multiplicación de ese número en formato string.
